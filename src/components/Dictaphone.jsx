...
const Dictaphone = () => {
  const { finalTranscript,transcript,interimTranscript, resetTranscript, browserSupportsSpeechRecognition } =
    useSpeechRecognition();
  ...
  const handleStartListening = () => {
    ...
    SpeechRecognition.startListening({
      continuous: true, // Automatically stops listening after input ends
      language: "en-IN",
    });
  };
